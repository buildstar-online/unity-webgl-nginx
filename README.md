...
This repo contains the resources and workflows required to build and deploy a Unity3D WebGL project using [GameCI](https://game.ci/), [Kubernetes](https://kubernetes.io/) and optionally [ArgoCD](https://argo-cd.readthedocs.io/en/stable/). A live demo deployment is available at http://webgl-nginx.buildstars.online/.
